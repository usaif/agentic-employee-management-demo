    ...
    try:
        ...
        if action == "create_session":
            ...
            return InvocationResponse(
                output={"session_id": session_id, "status": "created"}
            )
            ...
            if not agent_session:
                return InvocationResponse(
                    output={"session_id": session_id, "message": "Invalid session."}
                )
        ...
        return InvocationResponse(
            output={"error": he.detail, "status_code": he.status_code}
        )
    except Exception as e:
        ...
        return InvocationResponse(
            output={"error": f"{type(e).__name__}: {str(e)}", "type": type(e).__name__}
        )
